        ...
        <View style={styles.section}>
          ...
          <View style={[styles.settingsContainer, dynamicStyles.settingsContainer]}>
            ...
            {renderSettingItem(
              'card-outline',
              t('paymentMethods'),
              t('managePaymentOptions'),
              () => navigation.navigate('PaymentMethods')
            )}
            {renderSettingItem(
              'receipt-outline',
              t('purchaseHistory'),
              t('viewPastTransactions'),
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.settingsContainer, dynamicStyles.settingsContainer]}>
            {renderSettingItem(
              ...
              t('helpFAQ'),
              t('getAnswers'),
              () => Alert.alert(t('helpFAQ'), t('comingSoon'))
            )}
            {renderSettingItem(
              'document-text-outline',
              t('termsConditions'),
              t('readTerms'),
              () => Alert.alert(t('termsConditions'), t('comingSoon'))
            )}
            {renderSettingItem(
              'shield-checkmark-outline',
              t('privacyPolicy'),
              t('dataProtection'),
              () => Alert.alert(t('privacyPolicy'), t('comingSoon'))
            )}
            {renderSettingItem(
